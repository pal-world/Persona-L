      ...
      <div className='bg-white rounded-lg p-6 w-[90%] max-w-md'>
        ...
        <div className='flex items-center mb-4'>
          <div className='relative flex-1'>
            ...
            <input
              ...
              placeholder='sk-...'
              className='w-full pl-10 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500'
            />
          </div>
        ...
        <div className='flex justify-between'>
          <button
            ...
            className='px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors disabled:bg-gray-300'
          >
            키 삭제
          </button>
          ...
          <button
            ...
            className='px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:bg-purple-400 flex items-center'
          >
            {isLoading ? (
              <>
